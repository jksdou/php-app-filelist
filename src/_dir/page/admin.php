                        ...
                        <div class="tab-pane fade show active" id="set" role="tabpanel" aria-labelledby="set-tab">
                            <form onsubmit="return saveSetting(this)" method="post" role="form">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">网站名字</label>
                                    <div class="col-sm-9"><input type="text" name="brand" value="<?php echo $conf['brand']; ?>" class="form-control" required /></div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">网站SEO标题</label>
                                    <div class="col-sm-9"><input type="text" name="title" value="<?php echo $conf['title']; ?>" class="form-control" required /></div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">网站SEO关键字</label>
                                    <div class="col-sm-9"><input type="text" name="keywords" value="<?php echo $conf['keywords']; ?>" class="form-control" /></div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">网站SEO描述</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"><textarea class="form-control" name="nav" rows="3" placeholder=""><?php echo $conf['nav'] ?></textarea>
                                        <font color="green">填写格式：链接文字*链接地址|链接文字*链接地址</font>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">中文文件名编码</label>
                                    <div class="col-sm-9"><select class="form-control" name="name_encode" default="<?php echo $conf['name_encode'] ?>">
                                            <option value="utf8">UTF-8</option>
                                            <option value="gbk">GBK</option>
                                        </select>
                                        <font color="green">当出现中文文件名乱码的情况下可以修改此项</font>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">开启文件hash显示</label>
                                    <div class="col-sm-9"><select class="form-control" name="file_hash" default="<?php echo $conf['file_hash'] ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"><select class="form-control" name="readme_md" default="<?php echo $conf['readme_md'] ?>">
                                            <option value="0">关闭</option>
                                            <option value="1">开启</option>
                                        </select></div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"><select class="form-control" name="cache_indexes" default="<?php echo $conf['cache_indexes'] ?>">
                                            <option value="0">关闭</option>
                                            <option value="1">缓存1小时</option>
                                            <option value="2">缓存6小时</option>
                                            <option value="3">缓存24小时</option>
                                        </select>
                                        <font color="green">文件和目录数量多的情况下建议开启，可提升搜索速度。开启后如文件有变动需手动清除缓存</font>
                                    </div>
                                </div>
                                <div class="form-group row">
