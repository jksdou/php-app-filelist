...
class DirList
{
    ...
    public function get_all_files()
    {
        ...
        switch ($conf['cache_indexes']) {
            case '1':$cache_time = 3600;
                break;
            case '2':$cache_time = 3600 * 6;
                break;
            case '3':$cache_time = 3600 * 24;
                break;
            default:$cache_time = 0;
                break;
        }
        if ($cache_time > 0) {
    ...
    public function list_dir($dir = '.')
    {
        ...
        foreach ($files as $file) {
            ...
            if (is_dir($relativePath)) {
                ...
                if (($name == 'readme.md' || $name == 'README.md') && $size < 1024 * 1024 * 5) {
                    $readme_md = $relativePath;
                }
        ...
        if ($dir != '.') {
            ...
            if ($parentPath == '') {
                ...
                $parent = './?dir=' . rawurlencode($this->encoding($parentPath, true));
            }
